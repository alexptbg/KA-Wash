...
$orders = array();
$sql="SELECT * FROM `orders` WHERE `client_id`='".$_GET['id']."' ORDER BY `id` DESC LIMIT ".$start_from.", ".$limit;
                            ...
                            <div class="panel panel-bd">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4><i class="fa fa-align-justify" aria-hidden="true"></i>&nbsp;<?=$k129?>&nbsp;<?=$k184?>
                                            <?php
                                        ...
                                        <table id=\"orders\" class=\"table table-bordered table-striped table-hover\">
                                            ...
                                            <tbody>
                                                ...
                                                echo "
                                                    ...
                                                    <button type=\"button\" class=\"btn btn-sm btn-pink themed-tooltip\" onClick=\"order_edit('".$order['order_id']."','".$order['client_id']."'); return false;\" data-toggle=\"tooltip\" data-placement=\"bottom\" data-original-title=\"".$k225."\"><i class=\"fa fa-cog\"></i></button>
                                                    
                                                    <button type=\"button\" class=\"btn btn-sm btn-primary themed-tooltip\" onClick=\"order_invoice('".$order['order_id']."','".$order['client_id']."'); return false;\" data-toggle=\"tooltip\" data-placement=\"bottom\" data-original-title=\"".$k156."\"><i class=\"fa fa-file-text\"></i></button>
                                                    </td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
...
echo $pageLink."</ul>";  
        ...
        function order_invoice(order_id,client_id) {
			var invoice_order = "washorders_invoice_order.php?order_id="+order_id+"&client_id="+client_id;
