...
$d_ago = date("Y-m-d 00:00:00",strtotime('-1 day'));
$timed = date("Y-m-d H:i:s",strtotime("-5 minutes"));
$logs = array();
                                        ...
                                        <table id="logs" class="table table-bordered table-striped table-hover">
                                            ...
                                            foreach($logs as $log) {
											    ...
											    <tr>
												    ...
												    if ($log['washprep1'] < 1) { $label_1 = "label-danger"; $v_1 = $k029; } else { $label_1 = "label-success"; $v_1 = $k028; }
												    if ($log['washprep2'] < 1) { $label_2 = "label-danger"; $v_2 = $k029; } else { $label_2 = "label-success"; $v_2 = $k028; }
												    if ($log['washprep3'] < 1) { $label_3 = "label-danger"; $v_3 = $k029; } else { $label_3 = "label-success"; $v_3 = $k028; }
												    if ($log['washprep4'] < 1) { $label_4 = "label-danger"; $v_4 = $k029; } else { $label_4 = "label-success"; $v_4 = $k028; }
												    if ($log['washprep5'] < 1) { $label_5 = "label-danger"; $v_5 = $k029; } else { $label_5 = "label-success"; $v_5 = $k028; }
												    if ($log['washprep6'] < 1) { $label_6 = "label-danger"; $v_6 = $k029; } else { $label_6 = "label-success"; $v_6 = $k028; }
												    if ($log['washprep7'] < 1) { $label_7 = "label-danger"; $v_7 = $k029; } else { $label_7 = "label-success"; $v_7 = $k028; }
												    if ($log['washprep8'] < 1) { $label_8 = "label-danger"; $v_8 = $k029; } else { $label_8 = "label-success"; $v_8 = $k028; }
												    
												    echo "
												    <td>".
												      "<span class=\"label ".$label_1." themed-tooltip\" aria-hidden=\"true\" data-toggle=\"tooltip\" data-placement=\"bottom\" data-original-title=\"".$k113."&nbsp;1\">".$v_1."</span>&nbsp;".
												      "<span class=\"label ".$label_2." themed-tooltip\" aria-hidden=\"true\" data-toggle=\"tooltip\" data-placement=\"bottom\" data-original-title=\"".$k113."&nbsp;2\">".$v_2."</span>&nbsp;".
												      "<span class=\"label ".$label_3." themed-tooltip\" aria-hidden=\"true\" data-toggle=\"tooltip\" data-placement=\"bottom\" data-original-title=\"".$k113."&nbsp;3\">".$v_3."</span>&nbsp;".
												      "<span class=\"label ".$label_4." themed-tooltip\" aria-hidden=\"true\" data-toggle=\"tooltip\" data-placement=\"bottom\" data-original-title=\"".$k113."&nbsp;4\">".$v_4."</span>&nbsp;".
												      "<span class=\"label ".$label_5." themed-tooltip\" aria-hidden=\"true\" data-toggle=\"tooltip\" data-placement=\"bottom\" data-original-title=\"".$k113."&nbsp;5\">".$v_5."</span>&nbsp;".
												      "<span class=\"label ".$label_6." themed-tooltip\" aria-hidden=\"true\" data-toggle=\"tooltip\" data-placement=\"bottom\" data-original-title=\"".$k113."&nbsp;6\">".$v_6."</span>&nbsp;".
												      "<span class=\"label ".$label_7." themed-tooltip\" aria-hidden=\"true\" data-toggle=\"tooltip\" data-placement=\"bottom\" data-original-title=\"".$k113."&nbsp;7\">".$v_7."</span>&nbsp;".
												      "<span class=\"label ".$label_8." themed-tooltip\" aria-hidden=\"true\" data-toggle=\"tooltip\" data-placement=\"bottom\" data-original-title=\"".$k113."&nbsp;8\">".$v_8."</span>&nbsp;".
												    "</td>
												    ...
												    foreach($clients as $client) {
														if(($client != "") && ($client != " ")) {
														    ...
														    $c++;
														    if($client_name != "") {
														        echo "<span class=\"label label-p".$c." themed-tooltip\" data-toggle=\"tooltip\" data-placement=\"bottom\" data-original-title=\"".$client."\">".$client_name."</span>&nbsp;";
													        } else {
															    echo "<span class=\"label label-p".$c." themed-tooltip\" data-toggle=\"tooltip\" data-placement=\"bottom\" data-original-title=\"".$client."\">".$client."</span>&nbsp;";
														    }
													    }
													}
												    echo "
