...
check_login($appname);
$worklist = array();
$sql="SELECT * FROM `worklist` ORDER BY `id` ASC";
...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?=$config['base_url']?>/assets/flag-icon/css/flag-icon.min.css" />
        <link rel="stylesheet" type="text/css" href="<?=$config['base_url']?>/assets/plugins/toastr/toastr.min.css" />
        ...
        <link rel="stylesheet" type="text/css" href="<?=$config['base_url']?>/assets/dist/css/entypo.css" />
        <!-- lAUNdry icons -->
        <link rel="stylesheet" type="text/css" href="<?=$config['base_url']?>/assets/laundry/css/pe-laundry-icons.css" />
        <!--[if lt IE 9]>
    ...
    <body>
        ...
        <!-- START CORE PLUGINS -->
        <script type="text/javascript" src="<?=$config['base_url']?>/assets/plugins/jQuery/jquery-1.12.4.min.js"></script>
        <script type="text/javascript" src="<?=$config['base_url']?>/assets/plugins/jquery-ui-1.12.1/jquery-ui.min.js"></script>
        <script type="text/javascript" src="<?=$config['base_url']?>/assets/dist/js/jquery-migrate.min.js"></script>
        <script type="text/javascript" src="<?=$config['base_url']?>/assets/bootstrap/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="<?=$config['base_url']?>/assets/plugins/metisMenu/metisMenu.min.js"></script>
        <script type="text/javascript" src="<?=$config['base_url']?>/assets/plugins/lobipanel/lobipanel.min.js"></script>
        <script type="text/javascript" src="<?=$config['base_url']?>/assets/plugins/animsition/js/animsition.min.js"></script>
        <script type="text/javascript" src="<?=$config['base_url']?>/assets/plugins/fastclick/fastclick.min.js"></script>
        <script type="text/javascript" src="<?=$config['base_url']?>/assets/plugins/slimScroll/jquery.slimscroll.min.js"></script>
        <script type="text/javascript" src="<?=$config['base_url']?>/assets/plugins/toastr/toastr.min.js"></script>
        ...
        <!-- datatables -->
        <link type="text/css" rel="stylesheet" href="<?=$config['base_url']?>/assets/plugins/datatables/css/jquery.dataTables.css" />
        <link type="text/css" rel="stylesheet" href="<?=$config['base_url']?>/assets/plugins/datatables/extensions/Buttons/css/buttons.dataTables.css" />
        <script type="text/javascript" src="<?=$config['base_url']?>/assets/plugins/datatables/js/jquery.dataTables.min.js"></script>
        <script type="text/javascript" src="<?=$config['base_url']?>/assets/plugins/datatables/js/dataTables.bootstrap.min.js"></script>
        <script type="text/javascript" src="<?=$config['base_url']?>/assets/plugins/datatables/extensions/Buttons/js/dataTables.buttons.min.js"></script>
        <script type="text/javascript" src="<?=$config['base_url']?>/assets/plugins/datatables/js/jszip.min.js"></script>
        <script type="text/javascript" src="<?=$config['base_url']?>/assets/plugins/datatables/js/pdfmake.min.js"></script>
        <script type="text/javascript" src="<?=$config['base_url']?>/assets/plugins/datatables/js/vfs_fonts.js"></script>
        <script type="text/javascript" src="<?=$config['base_url']?>/assets/plugins/datatables/extensions/Buttons/js/buttons.html5.min.js"></script>
        <script type="text/javascript" src="<?=$config['base_url']?>/assets/plugins/datatables/extensions/Buttons/js/buttons.print.min.js"></script>
        <script type="text/javascript">
        $(function () {
            if(jQuery().dataTable) {
		...
		<!-- validation -->
		<link rel="stylesheet" type="text/css" href="<?=$config['base_url']?>/assets/plugins/validationEngine/jquery.validationEngine.css" />
		<script type="text/javascript" src="<?=$config['base_url']?>/assets/plugins/validationEngine/jquery.validationEngine.js"></script>
		<script type="text/javascript" src="<?=$config['base_url']?>/assets/plugins/validationEngine/jquery.validationEngine-<?=$lang?>.js"></script>
        <!-- START THEME LABEL SCRIPT -->
        <script type="text/javascript" src="<?=$config['base_url']?>/assets/dist/js/app.js"></script>
    </body>
</html>
