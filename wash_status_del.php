...
check_login($appname);
?>
<?php if((!empty($_GET)) && ($user_settings['level'] >= 100)): ?>
<form id="forms" class="form-horizontal" method="post">
    <div class="form-group">
        <label class="col-sm-12 control-label"><p class="text-danger fl"><strong><?=$lo14?>?</strong></p></label>
    </div>
	<div class="form-group"> 
