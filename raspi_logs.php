...
$logs = array();
$sql="SELECT * FROM `raspi_status` ORDER BY `id` DESC LIMIT ".$start_from.", ".$limit;
...
//pagination
$sqlp = "SELECT COUNT(id) AS COUNT FROM `raspi_status`";
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li class="active"><a href="raspi_logs.php">RASPBERRY</a></li>
                            </ul>
                        </li>
                            ...
                            <div class="panel panel-bd">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4><i class="fa fa-align-justify" aria-hidden="true"></i>&nbsp;<?=$k194?></h4>
                                        <div class="buttons fr">
                                            <?php if (($user_settings['level'] >= 50) && (!empty($logs))): ?>
                                        	<a type="button" class="btn btn-danger btn-xs btn-panel" id="del" href="raspi_logs_del.php?i=ok" data-remote="true" data-toggle="modal" data-target="#modal-n" data-backdrop="static" data-tag="<?=$lo08?>" data-class="modal-danger"><i class="fa fa-times themed-tooltip" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" data-original-title="<?=$lo08?>"></i></a>
                                        	<?php else: ?>
                                        	<button type="button" class="btn btn-danger btn-xs btn-panel themed-tooltip" data-toggle="tooltip" data-placement="bottom" data-original-title="<?=$lo08?>" disabled="disabled"><i class="fa fa-times themed-tooltip" aria-hidden="true"></i></button>
                                        	<?php endif; ?>
                                        </div>
                                    </div>
                                </div>
