                            ...
                            <div class="panel panel-bd">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4><i class="fa fa-list" aria-hidden="true"></i>&nbsp;<?=$kl02?></h4>
                                        <div class="buttons fr">
                                            <?php if ($user_settings['level'] >= 20): ?>
                                        	<a type="button" class="btn btn-primary btn-xs btn-panel" id="add" href="clients_add.php" data-remote="true" data-toggle="modal" data-target="#modal-n" data-backdrop="static" data-tag="<?=$kl03?>" data-class="modal-primary"><i class="fa fa-plus themed-tooltip" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" data-original-title="<?=$kl03?>"></i></a>
                                        	<?php else: ?>
                                        	<button type="button" class="btn btn-primary btn-xs btn-panel themed-tooltip" data-toggle="tooltip" data-placement="bottom" data-original-title="<?=$kl03?>" disabled="disabled"><i class="fa fa-plus themed-tooltip" aria-hidden="true"></i></button>
                                        	<?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="clients" class="table table-bordered table-striped table-hover">
                                            <thead>
                                                <tr>
											        <th><?=$kl27?></th>
											        <th><?=$kl28?></th>
                                            ...
                                            foreach($clients as $client) {
                                                ...
                                                echo "</td>
                                                    ...
                                                    if ($user_settings['level'] >= 50) {
														echo "
                                                    <a id=\"next\" href=\"clients_view.php?id=".$client['id']."\" class=\"btn btn-primary btn-sm themed-tooltip\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"".$kl59."\"><i class=\"fa fa-eye\"></i></a>
                                                    
                                                    <a id=\"edit\" href=\"clients_edit.php?id=".$client['id']."\" data-remote=\"true\" data-toggle=\"modal\" data-target=\"#modal-n\" data-backdrop=\"static\" data-tag=\"".$kl04."\" data-class=\"modal-warning\" class=\"btn btn-warning btn-sm\"><i class=\"fa fa-edit themed-tooltip\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"".$kl04."\"></i></a>
                                                    
                                                    <a id=\"card\" href=\"clients_card.php?id=".$client['id']."\" data-remote=\"true\" data-toggle=\"modal\" data-target=\"#modal-n\" data-backdrop=\"static\" data-tag=\"".$kl38."\" data-class=\"modal-danger\" class=\"btn btn-danger btn-sm\"><i class=\"fa fa-id-card themed-tooltip\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"".$kl37."\"></i></a>
                                                    
                                                    <a id=\"remove\" href=\"clients_remove.php?id=".$client['id']."\" data-remote=\"true\" data-toggle=\"modal\" data-target=\"#modal-n\" data-backdrop=\"static\" data-tag=\"".$kl05."\" data-class=\"modal-danger\" class=\"btn btn-danger btn-sm\"><i class=\"fa fa-trash themed-tooltip\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"".$kl05."\"></i></a>";
                                                    ...
                                                    <button data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"".$kl05."\" class=\"btn btn-danger btn-sm themed-tooltip\" disabled=\"disabled\"><i class=\"fa fa-trash\"></i></button>";
													} else {
													    echo "
													<a id=\"next\" href=\"clients_view.php?id=".$client['id']."\" class=\"btn btn-primary btn-sm themed-tooltip\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"".$kl59."\"><i class=\"fa fa-eye\"></i></a>
													
													<button data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"".$kl04."\" class=\"btn btn-warning btn-sm themed-tooltip\" disabled=\"disabled\"><i class=\"fa fa-edit\"></i></button>
													
													<button data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"".$kl37."\" class=\"btn btn-danger btn-sm themed-tooltip\" disabled=\"disabled\"><i class=\"fa fa-id-card\"></i></button>
