    ...
    <body>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li class="active">
                            ...
                            <ul class="nav nav-second-level">
								<li class="active"><a href="settings_washing_machines.php"><?=$s026?></a></li>
                            ...
                            <div class="panel panel-bd">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <h4><i class="fa fa-align-justify" aria-hidden="true"></i>&nbsp;<?=$s026?></h4>
                                        <div class="buttons fr">
                                            <?php if (($user_settings['level'] >= 20) && (count_washmachines()<=9)): ?>
                                        	<a type="button" class="btn btn-primary btn-xs btn-panel" id="del" href="settings_washing_machines_add.php?i=ok" data-remote="true" data-toggle="modal" data-target="#modal-n" data-backdrop="static" data-tag="<?=$k105?>" data-class="modal-primary"><i class="fa fa-plus themed-tooltip" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" data-original-title="<?=$k106?>"></i></a>
                                        	<?php else: ?>
                                        	<button type="button" class="btn btn-primary btn-xs btn-panel themed-tooltip" data-toggle="tooltip" data-placement="bottom" data-original-title="<?=$k106?>" disabled="disabled"><i class="fa fa-plus themed-tooltip" aria-hidden="true"></i></button>
                                        	<?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    <?php if(!empty($washmachinesid)): ?>
                                    <div class="table-responsive">
                                        <table id="washmachinesid" class="table table-bordered table-striped table-hover">
                                            <thead>
                                                <tr>
											        <th><?=$lo02?></th>
											        <th><?=$k057?></th>
                                            ...
                                            foreach($washmachinesid as $washmachine) {
												echo "
												<tr>
												    <td>".$washmachine['id']."</td>
												    <td>".$washmachine['number']."</td>
												    <td>".$washmachine['inv']."</td>
												    <td>".$washmachine['name']."</td>
												    <td>".$washmachine['brand']."</td>
												    <td>".$washmachine['model']."</td>
												    <td>".$washmachine['kg']." ".$wa07."</td>
												    <td>".$washmachine['water_before']."</td>
												    <td>".$washmachine['water_after']."</td>
												    <td>".$washmachine['place']."</td>
												    <td>";
												    if ($user_settings['level'] >= 50) {
														echo "
                                                    <a id=\"edit\" href=\"settings_washing_machines_edit.php?id=".$washmachine['id']."\" data-remote=\"true\" data-toggle=\"modal\" data-target=\"#modal-n\" data-backdrop=\"static\" data-tag=\"".$wa33."\" data-class=\"modal-warning\" class=\"btn btn-warning btn-sm\"><i class=\"fa fa-edit themed-tooltip\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"".$wa32."\"></i></a>
                                                    <!--
                                                    <a id=\"remove\" href=\"settings_washing_machines_remove.php?id=".$washmachine['id']."\" data-remote=\"true\" data-toggle=\"modal\" data-target=\"#modal-n\" data-backdrop=\"static\" data-tag=\"".$wa24."\" data-class=\"modal-danger\" class=\"btn btn-danger btn-sm\"><i class=\"fa fa-trash themed-tooltip\" data-toggle=\"tooltip\" data-placement=\"bottom\" title=\"".$wa24."\"></i></a>
                                                    -->
        ...
        $(function () {
            if(jQuery().dataTable) {
                ...
                if($("#washmachinesid").length > 0) { 
	                $("#washmachinesid").DataTable({
