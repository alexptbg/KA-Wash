    ...
    jQuery("#forms").on('click', '#submit', function(e) {
      ...
      if (valid == true) {
        ...
        if(type == "company") {
		    ...
		    //build string data
            var datastr = 'type='+type+'&number='+number+'&name='+name+'&phone='+phone+'&email='+email+'&region='+region+'&municipal='+municipal+'&grad_celo='+grad_celo+'&address='+addslashes(address)+'&company_name='+company_name+'&mol='+mol+'&ddc='+ddc+'&eik='+eik;
		}
        if(type == "person") {
			var egn = jQuery("input[name='egn']").val();
		    //build string data
            var datastr = 'type='+type+'&number='+number+'&name='+name+'&phone='+phone+'&email='+email+'&region='+region+'&municipal='+municipal+'&grad_celo='+grad_celo+'&address='+addslashes(address)+'&egn='+egn;
		}
        //console.log(datastr);
        send(datastr);
      } else {
